...
%     addpath('/path/to/yourownfunctions'); % you may need a directpry where you store random functions
    addpath('/Volumes/chp-matlab/heise/LEPAS/LEPAS_Pilot/EC');% change this to your directory where your analysis script sits
end
cd(eeglab_path)
eeglab
...
data_path = fullfile('/Volumes/chp-matlab/heise/LEPAS/LEPAS_Pilot/EC'); % this is where your data is currently, you can change it to a different directory once this is set up for your data collection
...
EEG = pop_reref( EEG,{'T7', 'TP10'}); % linked earlobes – change this into the channels, we actually used & documented
